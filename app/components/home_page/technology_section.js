  ...
  return (
    <div className="flex md:flex-row md:items-center md:justify-between flex-col  md:gap-0 gap-8 md:min-h-screen">
      ...
      <div className=" slide-in grid md:w-5/12 mt-8   grid-cols-4 gap-4 md:grid-cols-4">
        <div className="bg-gray-300/10 flex flex-col items-center justify-center gap-2 h-20 w-20 md:w-24 md:h-24 p-1 rounded-md hover:rounded-lg hover:scale-110 transition-all cursor-pointer"></div>
        <div className="bg-gray-300/10 flex flex-col items-center justify-center gap-2 h-20 w-20 md:w-24 md:h-24 p-1 rounded-md hover:rounded-lg hover:scale-110 transition-all cursor-pointer"></div>
        <div className="bg-gray-300/10 flex flex-col items-center justify-center gap-2 h-20 w-20 md:w-24 md:h-24 p-1 rounded-md hover:rounded-lg hover:scale-110 transition-all cursor-pointer"></div>
        <div className="bg-gray-300/10 flex flex-col items-center justify-center gap-2 h-20 w-20 md:w-24 md:h-24 p-1 rounded-md hover:rounded-lg hover:scale-110 transition-all cursor-pointer"></div>
        <div className="bg-gray-300/10 flex flex-col items-center justify-center gap-2 h-20 w-20 md:w-24 md:h-24 p-1 rounded-md hover:rounded-lg hover:scale-110 transition-all cursor-pointer"></div>
